...
// Three tabs, not bluestacks.com's four: onBlue has no EU Privacy or Copyright Dispute documents,
  ...
  return (
    <div className="crx revealed settled" id="crx">
      <header className="crx-legal-head">
        <Link href="/onblue" className="crx-legal-logo" aria-label="onBlue Partners home">
          <OnBlueWordmark size={17} />
        </Link>
      </header>
