...
// Copy, validation logic and flow verbatim; skin swapped to the /onblue kit. The panel is this
...
// The card carries className="crx" too, per onblue.css's own note, so the kit tokens resolve on a
// portaled overlay.
//
...
function MiniCheck({
  ...
  // forwards from the hidden input to the painted .crx-check sibling (onblue.css's selector).
  return (
