...
//      left guessing whether to keep running onBlue. So goal-met keeps the filled bar — it is the
...
// internal vocabulary ("Run onBlue" is the user-facing verb), and monthly programs name the window
// that counts.
