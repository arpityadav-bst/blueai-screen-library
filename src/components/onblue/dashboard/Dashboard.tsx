...
// Logic + copy verbatim; skin swapped to the /onblue kit. The returning creator's view — replaces
    ...
    <section className="crx-dash">
      ...
      <div className="crx-dash-head">
        <div>
          ...
          <p className="crx-dash-sub">Here&apos;s how your onBlue account is doing.</p>
        </div>
