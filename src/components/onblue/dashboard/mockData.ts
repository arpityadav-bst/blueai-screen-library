...
// comments all carry over unchanged; only the file's home moved to the /onblue dark flow.
//
...
// skill in onBlue on at least EARNING.daysRequired days in a month; each qualifying month adds one
...
export const MOCK_STATS = {
  ...
  // because "the number of jobs, onBlue runs etc will be a part of the program" (Abhisht,
