...
// dashboard reports — and what onBlue does is "campaigns and tasks" with no source named ("jobs"
// was tried and cut, PM 2026-08-14: an internal noun an applicant hasn't met yet). Order tells the
// program as
// a story: invite email → what onBlue does → your one obligation → the payoff → the terms. The email
...
const INTRO_POINTS = [
  ...
  },
  {
    ...
    // conclusion the hero sentence reached the same day: the counterparty is onBlue's side of the
