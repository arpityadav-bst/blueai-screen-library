...
// logic verbatim, skin swapped to the .crx kit (onblue.css flow-kit section).
//
...
// the sr-only input (onblue.css's `input.sr-only:focus-visible + …` rule), since without it the
