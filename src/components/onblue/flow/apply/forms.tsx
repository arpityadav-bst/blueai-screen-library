...
// Validation UI for the /onblue application — ported from creator-brand/forms.tsx, presentation
// swapped from Tailwind utilities to the .crx kit (onblue.css flow-kit section). One place, so
 ...
 * rules in onblue.css (withErr's original contract, same mechanism): equal specificity, later
