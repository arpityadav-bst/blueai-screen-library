...
// The footer — rebuilt 2026-08-20 from a single centred mono line (© 2026 onBlue · A now.gg
...
//     for that reason; see .crx-foot in onblue.css.
        ...
        <div className="crx-foot-cols">
          <div className="crx-foot-brand">
            ...
            <p className="crx-foot-legal">
              <a href="/onblue/terms">Terms and Privacy</a>
            </p>
          </div>
