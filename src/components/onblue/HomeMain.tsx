...
export default function HomeMain() {
  return (
    <>
      <main>
        ...
        {/* HAND-BROKEN (Appy, 2026-08-21) — the gradient half gets its own line rather than
            ...
            for this heading (onblue.css's wrapping notes carry the trap), which is harmless here
    ...
    comes from is onBlue's side of the arrangement, not the reader's, and every noun we tried
    ...
    "Real work" is the part that was doing the work all along.
        ...
        {/* HAND-BROKEN AT THE FULL STOP (Appy, 2026-08-27): one sentence per line - what onBlue
            ...
            onblue.css's wrapping notes - which is harmless here for exactly that reason. */}
        <p className="sub rv d2">
          onBlue is an AI worker you own.<br />
        ...
        <div className="scene rv d0" id="scene">
          {/* Coin icon removed (Appy, 2026-08-19: "remove dollar icon here and make this more
              ...
              onblue.css. The bottom-right mini counter that mirrored this pill on scroll is
