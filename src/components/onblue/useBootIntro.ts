...
// own staggered blur entry (onblue.css). Click/wheel/touch/key skips. prefers-reduced-motion
// skips the whole thing.
//
// STATE LIVES ON .crx AND body.crx-lock, not on body.revealed like the mock — see onblue.css's
