...
//   · the band GRADIENT is rebuilt from this page's tokens (onblue.css .crx-band) — the DS's own
...
// onblue.css .crx-band), and white lines on a white panel are invisible. The colour is set once
