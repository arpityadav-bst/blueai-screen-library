...
//
// HEADLINE REFRAMED (PM, 2026-08-20, after the Aug 18 CEO review): the landing says "You get it
// hired", so this page must not revert to you-as-applicant ("One short application" led before).
// The sub pays off the CTA's word — you clicked "Get access", so the promise is "when your access
// is approved": access is granted after review, not downloaded on click.
//
