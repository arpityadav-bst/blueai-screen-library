// VERSION B: the original v1 stat pair (Completed jobs + Earned/cash out), restored verbatim
// from origin/main — predates the programs model, so no Past-programs door and no balance split.
...
export default function StatCardsV1({
  completedJobs,
  balance,
  onCashOut,
}: {
