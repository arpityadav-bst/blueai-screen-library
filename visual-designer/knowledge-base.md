...
Last updated: 2026-06-12 (S4 audit — agent demo form kit `.jmf-*` + FileUpload/VideoCard; descendant-selector specificity trap; data-driven shared-template copy; SSR-fetch fallback when the in-page extension blocks URL-bearing reads)
