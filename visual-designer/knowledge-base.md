...
Last updated: 2026-06-12 (S5 audit — form-kit molecules; SG anatomy primitives + sg-demo page-root reset + :target token rings; the hash-navigation-isn't-a-reload verification trap; ink/page channel tokens)
